...
st.markdown("<h4 style = 'margin: -30px; color: #A0153E; text-align: center; font-family: italic'>BUILT BY EME ITA </h4>", unsafe_allow_html = True)
...
st.sidebar.image('chunneruser.png', width = 300, caption = 'Welcome Eme Ita')
...
model = joblib.load('expressochurnmodel.pkl')
...
if st.button('Check Churn Probability'):
    ...
    #background colour - #CE9F9F
    #secondary colour - #EAC2C2
    #font family - Helvetica
    #primary colour - #FF4B4B
    #text colour - #31333F 